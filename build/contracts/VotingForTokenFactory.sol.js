...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("VotingForTokenFactory error: Please call setProvider() first before calling new().");
    }

    var args = Array.prototype.slice.call(arguments);

    if (!this.unlinked_binary) {
      throw new Error("VotingForTokenFactory error: contract binary not set. Can't deploy new instance.");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("VotingForTokenFactory contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of VotingForTokenFactory: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to VotingForTokenFactory.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: VotingForTokenFactory not deployed or address not set.");
    }
  ...
  "default": {
    ...
    "events": {},
    "updated_at": 1476809898679,
    "links": {},
    "address": "0x6d33b0723e654b1c78a7f824fe43f235577097a8"
  }
};
  ...
  Contract.contract_name   = Contract.prototype.contract_name   = "VotingForTokenFactory";
  ...
  if (typeof module != "undefined" && typeof module.exports != "undefined") {
    ...
    // and we can use that.
    window.VotingForTokenFactory = Contract;
  }
})();
