...
(function() {
  ...
  Contract.new = function() {
    if (this.currentProvider == null) {
      throw new Error("VotingAgainstTokenFactory error: Please call setProvider() first before calling new().");
    }

    var args = Array.prototype.slice.call(arguments);

    if (!this.unlinked_binary) {
      throw new Error("VotingAgainstTokenFactory error: contract binary not set. Can't deploy new instance.");
    }
    ...
    if (unlinked_libraries != null) {
      ...
      throw new Error("VotingAgainstTokenFactory contains unresolved libraries. You must deploy and link the following libraries before you can deploy a new version of VotingAgainstTokenFactory: " + unlinked_libraries);
    }
  ...
  Contract.at = function(address) {
    if (address == null || typeof address != "string" || address.length != 42) {
      throw new Error("Invalid address passed to VotingAgainstTokenFactory.at(): " + address);
    }
  ...
  Contract.deployed = function() {
    if (!this.address) {
      throw new Error("Cannot find deployed address: VotingAgainstTokenFactory not deployed or address not set.");
    }
  ...
  "default": {
    ...
    "events": {},
    "updated_at": 1476809898666,
    "links": {},
    "address": "0x8813feb6374158f56a838690bb726558cdf7807b"
  }
};
  ...
  Contract.contract_name   = Contract.prototype.contract_name   = "VotingAgainstTokenFactory";
  ...
  if (typeof module != "undefined" && typeof module.exports != "undefined") {
    ...
    // and we can use that.
    window.VotingAgainstTokenFactory = Contract;
  }
})();
