...
contract VotingTokenFactory {
    ...
    /*function verifyVotingToken(address _tokenContract) returns (bool) {
    ...
    function createVotingoken() returns (address, address) {
        ...
        isVotingForToken[address(newAgainstToken)] = true;
        ...
        return (address(newForToken), address(newAgainstToken));
    }
}
